...
response = requests.get(signed_url_
...
print(f"Response text: {response.text}")  # Make sure to remove any API keys before sharing
        ...
        # Logs exatos solicitados pelo suporte da ElevenLabs

...
def chat():
    ...
    # Novo payload para a API de simulação de conversa em streaming
    # Ajustado para usar simulated_user_config e remover o histórico de mensagens do payload
    json_data = {
    ...
    # Tentar usar a nova API de Agentes primeiro
    try:
        agent_url = f"https://api.elevenlabs.io/v1/convai/agents/{ELEVENLABS_AGENT_ID}/simulate-conversation/stream"
        response = requests.post(agent_url, headers=headers, json=json_data, stream=True)
        ...
        print(f"Erro ao usar a nova API de Agentes: {e}. Tentando API de TTS como fallback.")
        ...
        try:
            ...
            # Para TTS, o payload é diferente, apenas o texto da mensagem
            tts_json_data = {
                "text": user_message,
                "stream": True
            }

...
def chat():
    ...
    try:
        ...
        # Endpoint correto e parâmetros de query
        ws_url = f"wss://api.elevenlabs.io/v1/convai/conversation?agent_id={ELEVENLABS_AGENT_ID}&xi_api_key={ELEVENLABS_API_KEY}"
